...
public class MypageController {
    ...
    @PostMapping(value = "/shippingRegister")
    ...
    public String Modifyread(long sno, Model model){
        ...
        return "shippingModify";
    }

    @PostMapping("/shippingModify")
